...
../target/stm32/startup/startup.cpp 

OBJS += \
./target/stm32/startup/startup-init.o \
./target/stm32/startup/startup.o 

CPP_DEPS += \
./target/stm32/startup/startup-init.d \
./target/stm32/startup/startup.d 


# Each subdirectory must supply rules for building sources it contributes
target/stm32/startup/%.o: ../target/stm32/startup/%.cpp
	@echo 'Building file: $<'
