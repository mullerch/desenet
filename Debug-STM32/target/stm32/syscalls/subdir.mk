...
C_SRCS += \
../target/stm32/syscalls/syscalls_minimal.c 

OBJS += \
./target/stm32/syscalls/syscalls_minimal.o 

C_DEPS += \
./target/stm32/syscalls/syscalls_minimal.d 


# Each subdirectory must supply rules for building sources it contributes
target/stm32/syscalls/%.o: ../target/stm32/syscalls/%.c
	@echo 'Building file: $<'
