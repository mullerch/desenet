...
C_SRCS += \
../target/stm32/cmsis/core_cm3.c \
../target/stm32/cmsis/system_stm32f10x.c 

OBJS += \
./target/stm32/cmsis/core_cm3.o \
./target/stm32/cmsis/system_stm32f10x.o 

C_DEPS += \
./target/stm32/cmsis/core_cm3.d \
./target/stm32/cmsis/system_stm32f10x.d 


# Each subdirectory must supply rules for building sources it contributes
target/stm32/cmsis/%.o: ../target/stm32/cmsis/%.c
	@echo 'Building file: $<'
