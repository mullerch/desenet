...
/**
 * @ingroup utils
 * @brief This class enables enables to paint the same manner into monochrome displays with or without graphical
...
public:
	/**
	 * @brief Creates a new instance o the painter class that works on the monochrome display interface given by
	 * 		  the pointer display.
	 *
